...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Data data2 = new Data.Builder()
                .putString(KEY_TASK_DESC, "Hey I am sending the work data 2")
                .build();
        Data data3 = new Data.Builder()
                .putString(KEY_TASK_DESC, "Hey I am sending the work data 3")
                .build();
        ...
        final OneTimeWorkRequest request2 = new OneTimeWorkRequest.Builder(MyWorker.class)
                .setInputData(data2)
                .setConstraints(constraints)
                .build();

        final OneTimeWorkRequest request3 = new OneTimeWorkRequest.Builder(MyWorker.class)
                .setInputData(data3)
                .setConstraints(constraints)
                .build();
